...
The UxrHiScoresPanelEnterName type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_UltimateXR_UI_Helpers_HiScores_UxrHiScoresPanelEnterName__ctor">UxrHiScoresPanelEnterName</a></td><td /></tr></table>&nbsp;
<a href="#uxrhiscorespanelentername-class">Back to Top</a>
...
## Methods
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_UltimateXR_UI_Helpers_HiScores_UxrHiScoresPanelEnterName_OnDisable">OnDisable</a></td><td>
Unsubscribes from events.
 (Overrides <a href="M_UltimateXR_Core_Components_UxrComponent_OnDisable">UxrComponent.OnDisable()</a>.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_UltimateXR_UI_Helpers_HiScores_UxrHiScoresPanelEnterName_OnEnable">OnEnable</a></td><td>
Subscribes to events.
 (Overrides <a href="M_UltimateXR_Core_Components_UxrComponent_OnEnable">UxrComponent.OnEnable()</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_UltimateXR_UI_Helpers_HiScores_UxrHiScoresPanelEnterName_Show">Show</a></td><td>
Shows the panel using a fade effect. The panel GameObject should be in an inactive state.</td></tr></table>&nbsp;
<a href="#uxrhiscorespanelentername-class">Back to Top</a>
