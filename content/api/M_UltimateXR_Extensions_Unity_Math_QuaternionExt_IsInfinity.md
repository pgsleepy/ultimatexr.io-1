# QuaternionExt.IsInfinity Method 
 

Checks whether the given Quaternion has any infinity value.
...
public static bool IsInfinity(
	 this in Quaternion self
)
```


#### Parameters
&nbsp;<dl><dt>self</dt><dd>Type: Quaternion<br />Source quaternion</dd></dl>

#### Return Value
Type: <a href="https://docs.microsoft.com/dotnet/api/system.boolean" target="_blank" rel="noopener noreferrer">Boolean</a><br />Whether the quaternion has any infinity value
