...
#### Parameters
&nbsp;<dl><dt>transform</dt><dd>Type: Transform<br />Transform to process all children of</dd><dt>includeInactive (Optional)</dt><dd>Type: <a href="https://docs.microsoft.com/dotnet/api/system.boolean" target="_blank" rel="noopener noreferrer">System.Boolean</a><br />Whether to include inactive MeshRenderers</dd></dl>
