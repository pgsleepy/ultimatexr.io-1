...
**C#**<br />
``` C#
public static Vector3 ToEuler180(
...
#### Parameters
&nbsp;<dl><dt>self</dt><dd>Type: Vector3<br />Euler angles to fix</dd></dl>

#### Return Value
Type: Vector3<br />Euler angles in the -180, 180 degrees range
