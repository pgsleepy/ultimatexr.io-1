...
#### Parameters
&nbsp;<dl><dt>self</dt><dd>Type: GameObject<br />The GameObject whose local Bounds to get</dd><dt>forceRecurseIntoChildren</dt><dd>Type: <a href="https://docs.microsoft.com/dotnet/api/system.boolean" target="_blank" rel="noopener noreferrer">System.Boolean</a><br />Whether to also encapsulate all renderers found in the children no matter if the GameObject has a Renderer component or not</dd></dl>

#### Return Value
Type: Bounds<br />Local Bounds of the GameObject if there is a Renderer component in it, or the Bounds that encapsulates all children renderers otherwise
