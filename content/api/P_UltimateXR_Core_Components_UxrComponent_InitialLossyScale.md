# UxrComponent.InitialLossyScale Property 
 

Gets the lossyScale value at the moment of <a href="M_UltimateXR_Core_Components_UxrComponent_Awake">Awake()</a>
...
**C#**<br />
``` C#
public Vector3 InitialLossyScale { get; }
```
