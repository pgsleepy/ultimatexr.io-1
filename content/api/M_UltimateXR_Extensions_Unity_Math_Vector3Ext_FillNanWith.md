...
**C#**<br />
``` C#
public static Vector3 FillNanWith(
...
#### Parameters
&nbsp;<dl><dt>self</dt><dd>Type: Vector3<br />Vector whose NaN values to replace</dd><dt>other</dt><dd>Type: Vector3<br />Vector with valid values</dd></dl>
