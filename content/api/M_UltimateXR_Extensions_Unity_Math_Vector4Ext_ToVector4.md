# Vector4Ext.ToVector4 Method 
 

Transforms an array of floats to a Vector4 component by component. If there are not enough values to read, the remaining values are set to NaN.
