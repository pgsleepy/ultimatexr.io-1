# UxrAsyncInitSingleton(*T*) Methods
 

The <a href="T_UltimateXR_Core_Components_Singleton_UxrAsyncInitSingleton_1">UxrAsyncInitSingleton(T)</a> generic type exposes the following members.
...
<a href="#uxrasyncinitsingleton(*t*)-methods">Back to Top</a>
