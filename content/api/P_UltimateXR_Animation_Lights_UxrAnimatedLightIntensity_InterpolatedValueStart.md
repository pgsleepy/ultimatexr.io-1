# UxrAnimatedLightIntensity.InterpolatedValueStart Property 
 

Gets or sets the start value when the animation mode is set to <a href="T_UltimateXR_Animation_UxrAnimationMode">Interpolate</a>.
...
**C#**<br />
``` C#
public float InterpolatedValueStart { get; set; }
```
