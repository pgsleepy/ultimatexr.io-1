# TransformExt.SetLocalPositionY Method 
 

Sets the localPosition.y value of a given Transform.
...
#### Parameters
&nbsp;<dl><dt>self</dt><dd>Type: Transform<br />Transform to set the localPosition.y of</dd><dt>y</dt><dd>Type: <a href="https://docs.microsoft.com/dotnet/api/system.single" target="_blank" rel="noopener noreferrer">System.Single</a><br />New y value</dd></dl>
