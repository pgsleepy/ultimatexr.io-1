# UxrControllerInput.IsInput2dDPadUp Method 
 


## Overload List
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")![Static member](media/static.gif "Static member")</td><td><a href="M_UltimateXR_Devices_UxrControllerInput_IsInput2dDPadUp">IsInput2dDPadUp(Single)</a></td><td>
...
Checks if the given 2-axis input corresponds to an up press in a digital pad.</td></tr></table>&nbsp;
<a href="#uxrcontrollerinput.isinput2ddpadup-method">Back to Top</a>
