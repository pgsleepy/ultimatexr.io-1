# UxrGrabbableObject.RotationResistance Property 
 

Gets or sets the resistance to the object being rotated. This can be used to smooth out the rotation but also to simulate heavy objects.
