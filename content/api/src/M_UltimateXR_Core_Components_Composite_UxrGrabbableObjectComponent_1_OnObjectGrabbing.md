# UxrGrabbableObjectComponent(*T*).OnObjectGrabbing Method 
 

Overridable event trigger method for the <a href="E_UltimateXR_Manipulation_UxrGrabbableObject_Grabbing">Grabbing</a> event that can be used to handle it without requiring to subscribe/unsubscribe.
...
**C#**<br />
``` C#
protected virtual void OnObjectGrabbing(
