# UxrAnimatedComponent(*T*).NoiseDurationSeconds Property 
 

Gets or sets the animation duration in seconds when the animation mode is set to <a href="T_UltimateXR_Animation_UxrAnimationMode">Noise</a>.
...
**C#**<br />
``` C#
public float NoiseDurationSeconds { get; set; }
```
