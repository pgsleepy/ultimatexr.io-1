...
Called when a component is about to change its unique id by using <a href="M_UltimateXR_Core_Components_UxrComponent_TrySetUniqueId">TrySetUniqueId(String)</a>. Parameters are oldId, newId.
