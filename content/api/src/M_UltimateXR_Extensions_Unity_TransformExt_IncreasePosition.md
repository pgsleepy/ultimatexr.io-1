# TransformExt.IncreasePosition Method 
 

Adds x, y and z values to the position of a given Transform.
...
**C#**<br />
``` C#
public static void IncreasePosition(
	this Transform self,
	float x,
	float y,
	float z
...
#### Parameters
&nbsp;<dl><dt>self</dt><dd>Type: Transform<br />Transform whose position to add the values to</dd><dt>x</dt><dd>Type: <a href="https://docs.microsoft.com/dotnet/api/system.single" target="_blank" rel="noopener noreferrer">System.Single</a><br />Value to add to position.x</dd><dt>y</dt><dd>Type: <a href="https://docs.microsoft.com/dotnet/api/system.single" target="_blank" rel="noopener noreferrer">System.Single</a><br />Value to add to position.y</dd><dt>z</dt><dd>Type: <a href="https://docs.microsoft.com/dotnet/api/system.single" target="_blank" rel="noopener noreferrer">System.Single</a><br />Value to add to position.z</dd></dl>
