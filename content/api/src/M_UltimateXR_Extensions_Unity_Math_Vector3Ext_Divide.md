# Vector3Ext.Divide Method 
 

Divides a Vector3 by another, checking for divisions by 0. Divisions by 0 have a result of 0.
...
#### Parameters
&nbsp;<dl><dt>self</dt><dd>Type: Vector3<br />Dividend</dd><dt>divisor</dt><dd>Type: Vector3<br />Divisor</dd></dl>

#### Return Value
Type: Vector3<br />Result vector
