# TransformExt.SetPositionX Method 
 

Sets the position.x value of a Transform.
...
#### Parameters
&nbsp;<dl><dt>self</dt><dd>Type: Transform<br />Transform whose position.x value to set</dd><dt>x</dt><dd>Type: <a href="https://docs.microsoft.com/dotnet/api/system.single" target="_blank" rel="noopener noreferrer">System.Single</a><br />New x value</dd></dl>
