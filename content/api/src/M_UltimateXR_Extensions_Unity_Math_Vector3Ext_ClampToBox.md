...
#### Parameters
&nbsp;<dl><dt>point</dt><dd>Type: Vector3<br />Point in world coordinates</dd><dt>box</dt><dd>Type: BoxCollider<br />Box collider to test against</dd></dl>

#### Return Value
Type: Vector3<br />Point clamped inside given box volume
