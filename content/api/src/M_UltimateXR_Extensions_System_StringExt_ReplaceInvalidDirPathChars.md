# StringExt.ReplaceInvalidDirPathChars Method 
...
**C#**<br />
``` C#
public static string ReplaceInvalidDirPathChars(
	this string self,
	char fallbackChar = '_'
)
```
