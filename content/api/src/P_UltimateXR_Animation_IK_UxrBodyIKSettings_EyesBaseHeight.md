# UxrBodyIKSettings.EyesBaseHeight Property 
 

Gets the height of the eyes starting from the avatar root Y. This is used to know where to place the avatar head knowing the camera will be positioned on the eyes.
...
**C#**<br />
``` C#
public float EyesBaseHeight { get; }
```
