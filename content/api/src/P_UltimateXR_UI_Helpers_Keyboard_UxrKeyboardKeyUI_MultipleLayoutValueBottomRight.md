# UxrKeyboardKeyUI.MultipleLayoutValueBottomRight Property 
 

Gets the character used in the bottom right corner when the key has multiple labels, because it supports combination with shift and alt gr.
...
**C#**<br />
``` C#
public char MultipleLayoutValueBottomRight { get; }
```
