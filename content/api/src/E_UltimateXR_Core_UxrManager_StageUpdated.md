...
Called right after an update stage in the current frame. See <a href="T_UltimateXR_Core_UxrUpdateStage">UxrUpdateStage</a>.
...
#### Value
Type: <a href="https://docs.microsoft.com/dotnet/api/system.action-1" target="_blank" rel="noopener noreferrer">System.Action</a>(<a href="T_UltimateXR_Core_UxrUpdateStage">UxrUpdateStage</a>)
