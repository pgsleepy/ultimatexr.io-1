# UxrControllerInput.GetButtonPressFlags Method 
...
**C#**<br />
``` C#
public uint GetButtonPressFlags(
...
#### Implements
<a href="M_UltimateXR_Devices_IUxrControllerInput_GetButtonPressFlags">IUxrControllerInput.GetButtonPressFlags(UxrHandSide, Boolean)</a><br />
