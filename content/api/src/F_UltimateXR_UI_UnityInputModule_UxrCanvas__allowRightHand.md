# UxrCanvas._allowRightHand Field
 

\[Missing <summary> documentation for "F:UltimateXR.UI.UnityInputModule.UxrCanvas._allowRightHand"\]
...
``` C#
[SerializeField]
protected bool _allowRightHand
```
