# UxrPositionTween.Animate Method 
 

Creates and starts a position tweening animation for the anchoredPosition of a Unity UI Graphic component.
...
**C#**<br />
``` C#
public static UxrPositionTween Animate(
	Graphic graphic,
