# Vector3Ext.GetPerpendicularVector Method 
...
**C#**<br />
``` C#
public static Vector3 GetPerpendicularVector(
	this Vector3 vector
)
```
...
#### Parameters
&nbsp;<dl><dt>vector</dt><dd>Type: Vector3<br />Vector to compute another perpendicular to</dd></dl>

#### Return Value
Type: Vector3<br />Perpendicular vector in 3D space
