# TransformExt.SetPositionZ Method 
 

Sets the position.z value of a Transform.
...
#### Parameters
&nbsp;<dl><dt>self</dt><dd>Type: Transform<br />Transform whose position.z value to set</dd><dt>z</dt><dd>Type: <a href="https://docs.microsoft.com/dotnet/api/system.single" target="_blank" rel="noopener noreferrer">System.Single</a><br />\[Missing <param name="z"/> documentation for "M:UltimateXR.Extensions.Unity.TransformExt.SetPositionZ(UnityEngine.Transform,System.Single)"\]</dd></dl>
