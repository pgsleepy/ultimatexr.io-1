...
#### Parameters
&nbsp;<dl><dt>self</dt><dd>Type: Transform<br />Caller</dd><dt>parent</dt><dd>Type: Transform<br />Transform to check if it is present</dd></dl>

#### Return Value
Type: <a href="https://docs.microsoft.com/dotnet/api/system.boolean" target="_blank" rel="noopener noreferrer">Boolean</a><br />True if present, false if not
