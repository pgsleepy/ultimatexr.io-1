# Vector3IntExt.ParseAsync Method 
 

Tries to parse a Vector3Int from a string, asynchronously.
...
**C#**<br />
``` C#
public static Task<Vector3Int?> ParseAsync(
	string s,
...
#### Return Value
Type: <a href="https://docs.microsoft.com/dotnet/api/system.threading.tasks.task-1" target="_blank" rel="noopener noreferrer">Task</a>(<a href="https://docs.microsoft.com/dotnet/api/system.nullable-1" target="_blank" rel="noopener noreferrer">Nullable</a>(Vector3Int))<br />Awaitable task returning the parsed vector or null if there was an error
