# GameObjectExt.CheckSetActive Method 
...
#### Parameters
&nbsp;<dl><dt>self</dt><dd>Type: GameObject<br />GameObject to activate</dd><dt>activate</dt><dd>Type: <a href="https://docs.microsoft.com/dotnet/api/system.boolean" target="_blank" rel="noopener noreferrer">System.Boolean</a><br />Whether to activate or deactivate the object</dd></dl>
