# UxrCanvas._fingerTipMinHoverDistance Field
 

\[Missing <summary> documentation for "F:UltimateXR.UI.UnityInputModule.UxrCanvas._fingerTipMinHoverDistance"\]
...
``` C#
[SerializeField]
protected float _fingerTipMinHoverDistance
```
