# UxrLaserPointer._rayColorNonInteractive Field
 

\[Missing <summary> documentation for "F:UltimateXR.UI.UxrLaserPointer._rayColorNonInteractive"\]
...
``` C#
[SerializeField]
protected Color _rayColorNonInteractive
```
