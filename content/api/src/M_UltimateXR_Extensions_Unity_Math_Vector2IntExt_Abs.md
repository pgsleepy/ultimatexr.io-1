...
#### Parameters
&nbsp;<dl><dt>self</dt><dd>Type: Vector2Int<br />Input vector</dd></dl>

#### Return Value
Type: Vector2Int<br />Result vector where each component is the absolute value of the input value component
