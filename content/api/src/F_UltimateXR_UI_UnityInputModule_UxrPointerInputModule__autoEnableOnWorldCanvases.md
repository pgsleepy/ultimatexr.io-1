# UxrPointerInputModule._autoEnableOnWorldCanvases Field
 

\[Missing <summary> documentation for "F:UltimateXR.UI.UnityInputModule.UxrPointerInputModule._autoEnableOnWorldCanvases"\]
...
``` C#
[SerializeField]
protected bool _autoEnableOnWorldCanvases
```
