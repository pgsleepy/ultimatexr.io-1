# UxrPointerInputModule._disableOtherInputModules Field
 

\[Missing <summary> documentation for "F:UltimateXR.UI.UnityInputModule.UxrPointerInputModule._disableOtherInputModules"\]
...
``` C#
[SerializeField]
protected bool _disableOtherInputModules
```
