# CursorExitedEventHandler Delegate
 

\[Missing <summary> documentation for "T:UltimateXR.UI.UnityInputModule.Controls.CursorExitedEventHandler"\]
...
**C#**<br />
``` C#
public delegate void CursorExitedEventHandler(
