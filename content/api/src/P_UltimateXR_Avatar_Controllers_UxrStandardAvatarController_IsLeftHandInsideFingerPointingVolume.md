# UxrStandardAvatarController.IsLeftHandInsideFingerPointingVolume Property 
 

Gets whether the left hand is inside an <a href="T_UltimateXR_Avatar_Controllers_UxrFingerPointingVolume">UxrFingerPointingVolume</a>.
...
**C#**<br />
``` C#
public bool IsLeftHandInsideFingerPointingVolume { get; }
```
