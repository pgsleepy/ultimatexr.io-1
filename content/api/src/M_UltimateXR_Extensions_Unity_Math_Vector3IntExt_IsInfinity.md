# Vector3IntExt.IsInfinity Method 
...
#### Parameters
&nbsp;<dl><dt>self</dt><dd>Type: Vector3Int<br />Vector to check</dd></dl>

#### Return Value
Type: <a href="https://docs.microsoft.com/dotnet/api/system.boolean" target="_blank" rel="noopener noreferrer">Boolean</a><br />Whether any component has an infinity value
