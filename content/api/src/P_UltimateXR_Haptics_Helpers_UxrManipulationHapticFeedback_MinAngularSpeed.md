# UxrManipulationHapticFeedback.MinAngularSpeed Property 
 

Gets the minimum manipulation angular speed. This is the same as <a href="P_UltimateXR_Haptics_Helpers_UxrManipulationHapticFeedback_MinSpeed">MinSpeed</a> but when rotating an object.
