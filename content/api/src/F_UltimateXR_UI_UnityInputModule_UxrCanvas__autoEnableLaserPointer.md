# UxrCanvas._autoEnableLaserPointer Field
 

\[Missing <summary> documentation for "F:UltimateXR.UI.UnityInputModule.UxrCanvas._autoEnableLaserPointer"\]
...
``` C#
[SerializeField]
protected bool _autoEnableLaserPointer
```
