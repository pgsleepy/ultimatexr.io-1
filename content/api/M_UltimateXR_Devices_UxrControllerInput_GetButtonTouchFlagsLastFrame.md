# UxrControllerInput.GetButtonTouchFlagsLastFrame Method 
 

Gets an uint value representing touch states for each the controller <a href="T_UltimateXR_Devices_UxrInputButtons">UxrInputButtons</a> flags in the last frame.
...
**C#**<br />
``` C#
public uint GetButtonTouchFlagsLastFrame(
...
#### Return Value
Type: <a href="https://docs.microsoft.com/dotnet/api/system.uint32" target="_blank" rel="noopener noreferrer">UInt32</a><br />Button flags representing touch states for each controller button in the last frame

#### Implements
<a href="M_UltimateXR_Devices_IUxrControllerInput_GetButtonTouchFlagsLastFrame">IUxrControllerInput.GetButtonTouchFlagsLastFrame(UxrHandSide, Boolean)</a><br />
