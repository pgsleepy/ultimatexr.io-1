# UxrAnimatedLightIntensity.NoiseValueEnd Property 
 

Gets or sets the end value when the animation mode is set to <a href="T_UltimateXR_Animation_UxrAnimationMode">Noise</a>.
...
**C#**<br />
``` C#
public float NoiseValueEnd { get; set; }
```
