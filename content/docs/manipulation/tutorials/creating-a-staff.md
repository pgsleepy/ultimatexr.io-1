...
{{< video src="/media/docs/manipulation/tutorials/creating-a-staff/staff_twirl.mp4" >}}
...
- Learn what `UxrGrabPointShapeAxisAngle` is used for, and its relationship with `UxrGrabbableObject`.
- Learn how to create a staff object using a single `UxrGrabbableObject` grab point as the base grip.
- Learn how to extend that grab point along the staff using `UxrGrabPointShapeAxisAngle`.
- Learn how to adjust the axis, offset range, and bidirectional settings so the staff can be grabbed naturally from anywhere along its length.
...
![](/media/docs/manipulation/tutorials/creating-a-staff/02AxisAngleComponent.png)
...
![](/media/docs/manipulation/tutorials/creating-a-staff/01StaffSetup.png)
...
![](/media/docs/manipulation/tutorials/creating-a-staff/03CenterObject.png)
...
![](/media/docs/manipulation/tutorials/creating-a-staff/05CenterTransformInComponent.png)
...
![](/media/docs/manipulation/tutorials/creating-a-staff/07LineAxisChanged.png)
...
![](/media/docs/manipulation/tutorials/creating-a-staff/08OffsetMinMax.png)
...
{{< video src="/media/docs/manipulation/tutorials/creating-a-staff/staff.mp4" >}}
