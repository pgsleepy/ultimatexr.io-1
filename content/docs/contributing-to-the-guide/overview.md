...
UltimateXR is an open-source framework, and its documentation is no different. Every article on this site lives in a public [GitHub repository](https://github.com/VRMADA/ultimatexr.io) and can be improved by anyone. Whether you spotted a typo, think a section could be clearer, or want to write a full tutorial on something that isn't covered yet, your contribution is welcome.

## What You Can Contribute

- **Typo and grammar fixes**: the quickest kind of contribution, and always appreciated.
- **Clarifications**: if a section confused you before you figured it out, improve it for the next person.
- **Missing parameters or steps**: if you notice an inspector parameter or setup step that isn't documented, add it.
- **New articles**: if you have built something with UltimateXR and want to share how, write a guide or tutorial.
- **Screenshots and videos**: visual aids make guides much easier to follow.
